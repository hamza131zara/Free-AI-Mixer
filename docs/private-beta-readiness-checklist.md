...
9. Report confusing auth, setup, workspace, reset, or unavailable states.
...
Never paste real keys, tokens, passwords, JWTs, anon keys, or service-role keys into docs, tickets, screenshots, or chat.
