-- Phase 27-B migration draft only.
...
-- Repository adapters, auth middleware, requester resolution, and RLS policies remain deferred.
...
-- Deferred:
-- - Supabase CLI setup and package installation
-- - migration execution
-- - RLS policies
-- - service-role access rules
-- - auth middleware and requester extraction
-- - repository adapter implementation
-- - signed URL generation
-- - production storage provider integration
